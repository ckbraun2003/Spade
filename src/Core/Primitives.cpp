...
namespace Spade {
  ...
  Mesh GenerateSphere(float radius, int sectors, int stacks) {
    ...
    for(int i = 0; i <= stacks; ++i) {
        ...
        for(int j = 0; j <= sectors; ++j) {
            ...
            mesh.vertices.push_back({{x, y, z}, {nx, ny, nz}, {s, t}});
        }
    }
  ...
  Mesh GenerateCube(float size) {
      ...
      // Face Normal -X
      mesh.vertices.push_back({{-half, -half, -half}, {-1,0,0}, {0,0}});
      mesh.vertices.push_back({{-half, -half,  half}, {-1,0,0}, {1,0}});
      mesh.vertices.push_back({{-half,  half,  half}, {-1,0,0}, {1,1}});
      mesh.vertices.push_back({{-half,  half, -half}, {-1,0,0}, {0,1}});
      ...
      // Face Normal -Y
      mesh.vertices.push_back({{-half, -half, -half}, {0,-1,0}, {0,0}});
      mesh.vertices.push_back({{ half, -half, -half}, {0,-1,0}, {1,0}});
      mesh.vertices.push_back({{ half, -half,  half}, {0,-1,0}, {1,1}});
      mesh.vertices.push_back({{-half, -half,  half}, {0,-1,0}, {0,1}});
  ...
  Mesh GenerateQuad(float size) {
      ...
      mesh.vertices.push_back({{-half, -half, 0}, {0,0,1}, {0,0}});
